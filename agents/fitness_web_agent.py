...
class FitnessWebAgent(BaseAgent):
    ...
    async def process(self, input_data: Any) -> Dict[str, Any]:
        ...
        analysis = await self._analyze_fitness_results(combined_results, search_query, search_type)
    ...
    def _enhance_fitness_query(self, query: str, search_type: str) -> str:
        ...
        fitness_terms = ["fitness", "strength", "muscle", "training", "workout", "exercise"]
    ...
    async def _analyze_fitness_results(self, results: List[Dict], original_query: str, search_type: str) -> Dict[str, Any]:
